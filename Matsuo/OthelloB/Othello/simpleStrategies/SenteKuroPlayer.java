...
public class SenteKuroPlayer extends Strategy {
	...
	private Move commonStrategy(GameState currentState){
		...
		if(check_state[0][0]==3){ //角
			...
			yoko=7;
			tate=6;
		}else if(check_state[1][1]==3 && check_state[0][0]==1){
			yoko=1;
			tate=1;
		}else if(check_state[6][1]==3 && check_state[7][0]==1){
			yoko=6;
			tate=1;
		}else if(check_state[0][6]==3 && check_state[0][7]==1){
			yoko=1;
			tate=6;
		}else if(check_state[6][6]==3 && check_state[7][7]==1){
			yoko=6;
			tate=6;
		}else {
			for(int k=2;k<SIZE-2;k++){
				...
				if(check_state[0][k]==3){
					...
					for(int l=2;l<SIZE-2;l++){
						if(next_state[0][l]==2||next_state[1][1]==2||next_state[1][6]==2){
							whiteCount++;
						}
					}
					if(whiteCount==0){
				...
				}else if(check_state[7][k]==3||next_state[6][1]==2||next_state[6][6]==2){
				...
				}else if(check_state[k][0]==3||next_state[1][1]==2||next_state[6][1]==2){
